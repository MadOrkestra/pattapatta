...
![Parallel segments clipped to a circle](https://pattapatta.madorkestra.com/assets/segment-set-parallel.svg)
...
Prefer the [hatch](https://pattapatta.madorkestra.com/api/hatch) helpers for filled regions.
