...
Read [Geometry model](/concepts/geometry-model) for `Path`, holes, and `Group` z-order.
...
Browse the [API reference](/api/shape-boolean) — each module page includes pictured examples.
