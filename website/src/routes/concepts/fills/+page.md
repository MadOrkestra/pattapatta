...
| Module | Marks |
|--------|-------|
| [tiling](/api/tiling) | Cell boundaries as stroke patterns (`arcDivision`, grids, subdivisions) |
| [contour](/api/contour) | Offset curves (inward / outward) |
| [pointSet](/api/point-set) | Hilbert-ordered polylines and TSP tours through samples |
| [construction](/api/construction) | `createSponge` pore boundaries as stroke fills |
