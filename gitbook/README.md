...
| Page | Purpose |
|------|---------|
| [Quickstart](quickstart.md) | Install and draw something in 2 minutes |
| [Getting started](getting-started.md) | Mental model, imports, a full mini pipeline |
| [API reference](api/shape-boolean.md) | Every module with pictured examples |

## Design notes

Internal research and ADRs live in the repo under `docs/` (not part of this GitBook root).
